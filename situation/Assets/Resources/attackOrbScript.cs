...
public class attackOrbScript : Photon.MonoBehaviour {

    public Rigidbody2D attack_orb;
...
//	public Transform Jasper;
    ...
    void Update()
    {
        ...
        {
            counter++;
            PhotonNetwork.Instantiate(this.attack_orb.name, transform.position, transform.rotation, 0);
            Shoot();
